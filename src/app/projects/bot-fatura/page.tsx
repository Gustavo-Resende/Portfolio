          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6 order-1 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <ul className="space-y-3 pt-4 font-mono text-sm md:text-base flex flex-col items-center lg:items-start px-2 max-w-[26rem]">
                <li className="flex items-start gap-3 text-white/80 text-left break-words leading-relaxed"><CheckCircle2 className="text-lime-primary w-4 h-4 shrink-0" /> {t.projectPages.botFatura.features.f1.checks[0]}</li>
                <li className="flex items-start gap-3 text-white/80 text-left break-words leading-relaxed"><CheckCircle2 className="text-lime-primary w-4 h-4 shrink-0" /> {t.projectPages.botFatura.features.f1.checks[1]}</li>
              </ul>
            </div>
...
public record ReguaConfig(
    ...
    int? DiasOffset
            ...
            <div className="space-y-6 order-1 lg:order-2 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <ul className="space-y-3 pt-4 font-mono text-sm md:text-base flex flex-col items-center lg:items-start px-2 max-w-[26rem]">
                <li className="flex items-start gap-3 text-white/80 text-left break-words leading-relaxed"><CheckCircle2 className="text-amber-500 w-4 h-4 shrink-0" /> {t.projectPages.botFatura.features.f2.checks[0]}</li>
                <li className="flex items-start gap-3 text-white/80 text-left break-words leading-relaxed"><CheckCircle2 className="text-amber-500 w-4 h-4 shrink-0" /> {t.projectPages.botFatura.features.f2.checks[1]}</li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6 order-1 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <ul className="space-y-3 pt-4 font-mono text-sm md:text-base flex flex-col items-center lg:items-start px-2 max-w-[26rem]">
                <li className="flex items-start gap-3 text-white/80 text-left break-words leading-relaxed"><CheckCircle2 className="text-lime-primary w-4 h-4 shrink-0" /> {t.projectPages.botFatura.features.f3.checks[0]}</li>
                <li className="flex items-start gap-3 text-white/80 text-left break-words leading-relaxed"><CheckCircle2 className="text-lime-primary w-4 h-4 shrink-0" /> {t.projectPages.botFatura.features.f3.checks[1]}</li>
              </ul>
            </div>
            <div className="relative w-full aspect-square md:aspect-[4/3] order-2 lg:order-2">
               <CodeCarousel
    ...
    <div ref={containerRef} className="max-w-6xl mx-auto relative px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-24 md:gap-20 lg:gap-24 relative z-10">
        ...
        <div className="flex flex-col items-center text-center gap-6 relative">
          <motion.div
            initial={{ scale: 0, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }} viewport={{ once:true, margin: "-100px" }}
            className="w-[90px] h-[90px] md:w-28 md:h-28 shrink-0 rounded-full bg-black border-2 border-lime-primary/80 flex items-center justify-center shadow-[0_0_20px_rgba(163,230,53,0.15)]"
          >
