...
import { ArrowLeft, CheckCircle2, Calendar, Code2, Briefcase, Target, Lightbulb, AlertTriangle, Zap, Server, Activity, TrendingUp, ChevronLeft, ChevronRight, Layout, Database, Shield, MessageSquare, CreditCard, PieChart } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-text-body text-xl font-light leading-relaxed max-w-xl">
              Uma solução inteligente de cobrança via WhatsApp, integrada ao ecossistema Frigg para automatizar o envio de faturas, lembretes de pagamento e conciliação bancária.
            </p>

            <div className="flex flex-wrap gap-4 pt-4">
              <div className="flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-xl">
                <CreditCard className="w-5 h-5 text-lime-primary" />
                <span className="text-sm font-mono tracking-tight text-white/80">FinTech</span>
              </div>
              <div className="flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-xl">
                <MessageSquare className="w-5 h-5 text-lime-primary" />
                <span className="text-sm font-mono tracking-tight text-white/80">WaAPI</span>
              </div>
              <div className="flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-xl">
                <PieChart className="w-5 h-5 text-lime-primary" />
                <span className="text-sm font-mono tracking-tight text-white/80">Auto-Recon</span>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-24 px-4 relative z-10 w-full max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-text-muted leading-relaxed">
                Inadimplência alta devido ao esquecimento de pagamentos e a fricção de acessar portais de faturas por e-mail, que muitas vezes caem no spam.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-black/80 font-medium leading-relaxed">
                Reduzir a taxa de churn e inadimplência levando a fatura direto para a palma da mão do cliente via WhatsApp.
              </p>
            </div>
          </motion.div>
          ...
          >
             ...
             <p className="text-text-muted leading-relaxed">
               Integração de Workers .NET que monitoram datas de vencimento e disparam mensagens humanizadas com boletos/PIX.
             </p>
          </motion.div>
        </div>
      </section>
